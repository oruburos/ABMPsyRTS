...
A simple model, consisting of three agent types: participant, competitor, and predators. The participant, predator and competitorswander around the grid at random. Participants and Competitors forage for resources, and predators preys participants and competitors if they end up on the same grid cell.
